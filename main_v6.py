...
from map_widget_v3 import DroneMapWidget
...
class TelemetryWorker(QThread):
    ...
    def __init__(self):
        ...
        self.drone = None
        self.mission_upload_queue = queue.Queue()
    ...
    def run(self):
        ...
        while self.is_running:
            if not self.mission_upload_queue.empty():
                waypoints = self.mission_upload_queue.get()
                try:
    ...
    def upload_mission(self, waypoints):
        self.mission_upload_queue.put(waypoints)
